...
xbmc.executebuiltin("Notification(ADDON SKIN RAYFLIX,Téléchargement en cours...)")
...
#active addon
xbmc.executeJSONRPC('{"jsonrpc": "2.0", "id":1, "method": "Addons.SetAddonEnabled", "params": { "addonid": "plugin.program.skinrayflix", "enabled": true }}')
xbmc.executeJSONRPC('{"jsonrpc": "2.0", "id":1, "method": "Addons.SetAddonEnabled", "params": { "addonid": "plugin.program.saverayflix", "enabled": true }}')
xbmc.executeJSONRPC('{"jsonrpc": "2.0", "id":1, "method": "Addons.SetAddonEnabled", "params": { "addonid": "plugin.program.preniumuptobox", "enabled": true }}')
