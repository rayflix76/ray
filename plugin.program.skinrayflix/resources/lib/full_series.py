...
xbmc.executebuiltin("Notification(PACK SKIN SERIES,Téléchargement en cours...)")

# telechargement et extraction du zip
zipurl = 'https://github.com/rayflix76/pack/raw/kodi/full_series.zip'
...
xbmc.executebuiltin("Notification(ACTUALISATION DU SKIN, Pack Skin Series...)")
xbmc.sleep(2000)
